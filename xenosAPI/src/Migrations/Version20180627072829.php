 ...
 */
final class Version20180627072829 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE zone (id INT AUTO_INCREMENT NOT NULL, planet_id INT NOT NULL, name VARCHAR(100) NOT NULL, description VARCHAR(100) NOT NULL, price INT NOT NULL, temperature DOUBLE PRECISION NOT NULL, gravity DOUBLE PRECISION NOT NULL, distance VARCHAR(100) NOT NULL, radius VARCHAR(30) DEFAULT NULL, INDEX IDX_A0EBC007A25E9820 (planet_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
